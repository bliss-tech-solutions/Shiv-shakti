...
const clients = [
  ...
  { name: "Addor Group", logo: "/clients/addor_group_logo.png" },
  { name: "Zaveri Group", logo: "/clients/zaveri.png" },
  { name: "Shanay LLP", logo: "/clients/shanay llp.webp" },
];
      ...
      <div className="clients-section container">
        ...
        >
          ...
          <p className="section-subtitle">
            We are proud to partner with India's leading infrastructure
            developers and real estate groups.
          </p>
        </motion.div>
